...
@mixin btn-bootswatch($class,$bg,$color) {
  .btn-#{$class} {
    &:focus {
      background-color: $bg;
    ...
    @include ripple-bootswatch($color);
  }
...
@include btn-bootswatch(primary, $primary, $white);
@include btn-bootswatch(secondary, $secondary, $gray-500);
@include btn-bootswatch(success, $success, $white);
@include btn-bootswatch(info, $info, $white);
@include btn-bootswatch(warning, $warning, $white);
@include btn-bootswatch(danger, $danger, $white);
@include btn-bootswatch(dark, $dark, $white);
@include btn-bootswatch(light, $light, $white);
