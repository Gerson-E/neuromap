...
.btn-primary,
.btn-primary:hover {
  @include btn-shadow-bootswatch($primary);
}
...
.btn-success,
.btn-success:hover {
  @include btn-shadow-bootswatch($success);
}

.btn-info,
.btn-info:hover {
  @include btn-shadow-bootswatch($info);
}

.btn-warning,
.btn-warning:hover {
  @include btn-shadow-bootswatch($warning);
}

.btn-danger,
.btn-danger:hover {
  @include btn-shadow-bootswatch($danger);
}

.btn-dark,
.btn-dark:hover {
  @include btn-shadow-bootswatch($dark);
}

.btn-light,
.btn-light:hover {
  @include btn-shadow-bootswatch($light);
}
