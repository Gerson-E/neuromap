...
@mixin glass-bootswatch($opacity: $frosted-opacity, $bg: $white) {
  border: none;
  box-shadow: inset 1px 1px $border-color, inset -1px -1px rgba($white, .1), $box-shadow;
  @include frost-bootswatch($opacity, $bg);
...
@mixin frost-bootswatch($opacity: $frosted-opacity, $bg: $white) {
...
.nav-tabs {
  ...
  .nav-item.show .nav-link {
    @include glass-bootswatch(1, $white);
